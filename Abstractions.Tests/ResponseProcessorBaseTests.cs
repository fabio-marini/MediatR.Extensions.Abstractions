    ...
    public class ResponseProcessorBaseTests
    {
        ...
        public ResponseProcessorBaseTests()
        {
            ...
            svc = new ServiceCollection()
                ...
                .AddTransient<TestResponseProcessor<TestCommand, Unit>>()
                .AddTransient<TestResponseProcessor<TestQuery, TestResult>>()
        ...
        public async Task Test1<TRequest, TResponse>(TRequest req, TResponse res) where TRequest : IRequest<TResponse>
        {
            ...
            var responseBehavior = svc.GetRequiredService<TestResponseProcessor<TRequest, TResponse>>();
