    ...
    public class RequestBehaviorBaseTests
    {
        ...
        public RequestBehaviorBaseTests()
        {
            ...
            svc = new ServiceCollection()
                ...
                .AddTransient<TestRequestBehavior<TestCommand, Unit>>()
                .AddTransient<TestRequestBehavior<TestQuery, TestResult>>()
        ...
        public async Task Test1<TRequest, TResponse>(TRequest req, TResponse res) where TRequest : IRequest<TResponse>
        {
            ...
            var requestBehavior = svc.GetRequiredService<TestRequestBehavior<TRequest, TResponse>>();
